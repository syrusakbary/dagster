...
# Placeholder class to cause the unregistered notebook solid to fail -- custom serialization_strategys require
...
ComplexDagsterType = as_dagster_type(
    pd.DataFrame, serialization_strategy=ComplexSerializationStrategy()
)
