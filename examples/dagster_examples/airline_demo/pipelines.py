    ...
    return PipelineDefinition(
        ...
        preset_definitions=[
            PresetDefinition(
                ...
                mode='local',
                environment_files=[
                    file_relative_path(__file__, 'environments/local_base.yml'),
                    file_relative_path(__file__, 'environments/local_fast_ingest.yml'),
                ],
            ),
            PresetDefinition(
                name='local_full',
                ...
                environment_files=[
                    file_relative_path(__file__, 'environments/local_base.yml'),
                    file_relative_path(__file__, 'environments/local_full_ingest.yml'),
                ],
            ),
        ],
    )
    ...
    return PipelineDefinition(
        ...
        preset_definitions=[
            PresetDefinition(
                ...
                environment_files=[
                    file_relative_path(__file__, 'environments/local_base.yml'),
                    file_relative_path(__file__, 'environments/local_warehouse.yml'),
                ],
            )
        ],
    )
